...
FALLBACK_CHAINS: dict[str, list[tuple[str, str]]] = {
    "reasoning": [
        ("nous_portal", "zai-org/glm-5.2"),          # nicht verifiziert (kein NOUS_PORTAL_API_KEY) – wird ohne Key uebersprungen
        ("openrouter", "tencent/hy3"),               # OK (OR-Katalog 2026-07-22)
        ("nvidia_nim", "z-ai/glm-5.2"),              # FIX: war "zai-org/glm-5.2" -> NIM-Katalog hat "z-ai/glm-5.2"
        ("openrouter", "stepfun/step-3.7-flash"),    # FIX: war "stepfun-ai/step-3.7-flash" -> OR-Katalog hat "stepfun/step-3.7-flash"
    ],
    "coding": [
        ("nous_portal", "deepseek/deepseek-v4-pro"), # nicht verifiziert (kein NOUS_PORTAL_API_KEY)
        ("openrouter", "poolside/laguna-s-2.1"),     # OK (OR-Katalog)
        ("nvidia_nim", "deepseek-ai/deepseek-v4-pro"), # OK (NIM-Katalog)
        ("openrouter", "poolside/laguna-xs-2.1"),    # OK (OR-Katalog)
    ],
    "long_context": [
        ("nous_portal", "nvidia/nemotron-3-ultra"),  # nicht verifiziert (kein NOUS_PORTAL_API_KEY)
        ("openrouter", "nvidia/nemotron-3-ultra-550b-a55b"),  # FIX: war "nvidia/nemotron-3-ultra" -> OR-Katalog hat "nvidia/nemotron-3-ultra-550b-a55b"
        ("nvidia_nim", "nvidia/nemotron-3-ultra-550b-a55b"),  # FIX: war "nvidia/nemotron-3-ultra" -> NIM-Katalog hat "nvidia/nemotron-3-ultra-550b-a55b"
    ],
}
